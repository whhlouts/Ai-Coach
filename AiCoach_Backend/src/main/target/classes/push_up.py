...
if __name__ == "__main__":
    ...
    params = {"model_folder": "D:\soft\openpose-master\models", "model_pose": "BODY_25", "net_resolution": "-1x176"}
    openpose = op.WrapperPython()
    openpose.configure(params)
    openpose.start()

    cap_standard = cv2.VideoCapture("D:\毕业设计\AiCoach\static\static\video\11月29日.mp4")
    cap = cv2.VideoCapture("D:\毕业设计\AiCoach\static\static\video\11月29日.mp4")
